...
Copyright (c) 2013-2014 GBcoin Developers
...
Intro
---------------------
GBcoin is a free open source peer-to-peer electronic cash system that is
...
Setup
---------------------
You need the Qt4 run-time libraries to run GBcoin-Qt. On Debian or Ubuntu:
